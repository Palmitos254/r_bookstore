...
public class RoniBookstoreApplication {
	...
	public CommandLineRunner bookDemo(BookRepository repository) {
		return (args) -> {
			...
			repository.save(new Book("J.K Rowling", "Harry Potter", "030-2211-3-8756-07", 1997, 20));
			repository.save(new Book("Edgar Rice Burroughs", "John Carter", "030-2630-0-85-0768", 1964, 20));
